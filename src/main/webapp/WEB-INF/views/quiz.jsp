...
<body>
	...
	<nav
		class="navbar navbar-expand-lg navbar-dark site-header bg-dark sticky-top py-1">
		<div class="container">
			...
			<div class="col-md">
				...
				<form class="form-group" action="quizresult">
					...
					<div id="question1" class="row">
						<div class="col-md">
							<h3>1. Your birthday is fast approaching, and your idea of
								attending a big party thrown in your honor is:</h3>
							<ol>
								<li>
									<div class="form-check">
										<label class="form-check-label"> <input type="radio"
											class="form-check-input" name="question1" value="happiness">I’m
											stoked, bring on the cake!
										</label>
									</div>
								</li>
								<li>
									<div class="form-check">
										<label class="form-check-label"> <input type="radio"
											class="form-check-input" name="question1" value="surprise">Uh-oh,
											panic poops.
										</label>
									</div>
								</li>
								<li>
									<div class="form-check">
										<label class="form-check-label"> <input type="radio"
											class="form-check-input" name="question1" value="neutral">I
											stopped counting after my 1st child.
										</label>
									</div>
								</li>
								<li>
									<div class="form-check">
										<label class="form-check-label"> <input type="radio"
											class="form-check-input" name="question1" value="anger">Who’s
											paying?
										</label>
									</div>
								</li>
								<li>
									<div class="form-check">
										<label class="form-check-label"> <input type="radio"
											class="form-check-input" name="question1" value="sadness">I
											don’t deserve this.
										</label>
									</div>
								</li>
					...
					<h3>3. You're cornered by your enemies. Think fast! Weapon of
						choice?</h3>
					<ol>
						<li>
							<div class="form-check">
								<label class="form-check-label"> <input
									class="form-check-input" type="radio" name="question3"
									value="surprise"> Cast-iron frying pan.
								</label>
							</div>
						</li>
						<li>
							<div class="form-check">
								<label class="form-check-label"> <input
									class="form-check-input" type="radio" name="question3"
									value="happiness"> I can control climate, and am
									therefore, a god.
								</label>
							</div>
						</li>
						<li>
							<div class="form-check">
								<label class="form-check-label"> <input
									class="form-check-input" type="radio" name="question3"
									value="neutral"> Not worth the effort, I’m gardening.
								</label>
							</div>
						</li>
						<li>
						...
						<li>
							<div class="form-check">
								<label class="form-check-label"> <input
									class="form-check-input" type="radio" name="question3"
									value="sadness"> Talk with me long enough, and I’ll
					...
					<h3>4. It’s 6AM, and the Sun has fired her first peal of
						orange across the horizon. The new day is on its way inexorably
						through the blinds, and into your crusty eyeballs—this is your cue
						to:</h3>
					<ol>
						<li>
							<div class="form-check">
								<label class="form-check-label"> <input
									class="form-check-input" type="radio" name="question4"
									value="happiness">Seize the day; I’m thinking of doing
						...
						<li>
							<div class="form-check">
								<label class="form-check-label"> <input
									class="form-check-input" type="radio" name="question4"
									value="surprise">Oh crap, I’ve got all that stuff I’ve
									got to do! (Charges like bull through Pfaltzgraff’s)
								</label>
							</div>
						</li>
						<li>
							<div class="form-check">
								<label class="form-check-label"> <input
									class="form-check-input" type="radio" name="question4"
									value="neutral">Gee, I’ve only just noticed how much
									this blanket feels like heaven… (Hits the snooze)
								</label>
							</div>
						</li>
						<li>
							<div class="form-check">
								<label class="form-check-label"> <input
									class="form-check-input" type="radio" name="question4"
									value="anger">Whoever or whatever is trying to wake me
									up is about meet their end via deadblow mallet.
								</label>
							</div>
						</li>
						<li>
							<div class="form-check">
								<label class="form-check-label"> <input
									class="form-check-input" type="radio" name="question4"
									value="sadness">I must invite you… to just leave me
									alone. (Draws curtains)
								</label>
							</div>
						</li>
					</ol>
					...
					<ol>
						<li>
							<div class="form-check">
								<label class="form-check-label"> <input
									class="form-check-input" type="radio" name="question5"
									value="neutral">"Your identity is your most valuable
						...
						<li>
							<div class="form-check">
								<label class="form-check-label"> <input
									class="form-check-input" type="radio" name="question5"
									value="anger">“I never go back on my word!”
								</label>
							</div>
						</li>
						<li>
							<div class="form-check">
								<label class="form-check-label"> <input
									class="form-check-input" type="radio" name="question5"
									value="sadness">“Forever is a long time, and time has a
						...
						<li>
							<div class="form-check">
								<label class="form-check-label"> <input
									class="form-check-input" type="radio" name="question5"
									value="happiness">"Venture outside your comfort zone.
					...
					<input id="button" class="btn btn-secondary" type="submit"
						value="Submit">
				</form>
